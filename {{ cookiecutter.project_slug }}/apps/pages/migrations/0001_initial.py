        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        help_text=(
                            "The referrer code from URL parameter "
                            "(e.g., 'producthunt' from ?ref=producthunt)"
                        ),
                        max_length=100,
                        unique=True,
                    ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Optional discount coupon code",
                        max_length=100,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text=(
                            ...
                            "(e.g., 'bg-gradient-to-r from-red-500 to-red-600' or 'bg-blue-600')"
                        ),
                        max_length=100,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        help_text=(
                            ...
                            "(e.g., 'text-white' or 'text-gray-900')"
                        ),
                        max_length=50,
                    ),
                ),
